...
halflife %>% filter(term == c(1883, 1910, 1950)) -> hfl
...
No, version 2 does not produce similar results to the paper. While the overall trend is still negative, the curve is different and the plot is more scattered.
